...
public class GUI_1 extends JPanel {
    ...
    Font font_menu_1 = new Font("Courier New", Font.PLAIN, 17);

    Font font_menuitem_1 = new Font("Courier New", Font.PLAIN, 14);
    Font font_menuitem_2 = new Font("Courier New", Font.BOLD, 14);
    ...
    class actions implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e_get == menu_1_item_2) {
                ...
                result = fileChooser_open.showOpenDialog(GUI_1.this);
            ...
            if (e_get == menu_1_item_4)
            {
                if(textArea_redactor_1.getText()!=null) {
                    result = fileChooser_save.showSaveDialog(GUI_1.this);
            ...
            if (e_get == menu_3_item_2)
            {
                ...
                if(size!=0)
                {
                    textArea_redactor_1.setFont(new Font("Arial", Font.PLAIN, size));
                }
            }
            //4
            /** Dark Mode */
